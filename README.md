...
[![Build Status](https://img.shields.io/github/actions/workflow/status/hectororm/query/tests.yml?branch=main&style=flat-square)](https://github.com/hectororm/query/actions/workflows/tests.yml?query=branch%3Amain)
